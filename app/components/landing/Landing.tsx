...
export default function Landing() {
  return (
    <section className="relative bg-[url(/image/anime-2.jpg)] bg-cover bg-center bg-no-repeat">
      <div className="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex h-screen lg:items-center lg:px-8">
        <div className="flex flex-col items-center max-w-xl text-center mx-auto mb-44 ltr:sm:text-left rtl:sm:text-right">
          ...
          <a href="" className='text-rose-700 underline bg-white p-1 rounded border-2 border-bone-500'>Continue as a guest</a>
        </div>
      </div>
    </section>
  );
...
const Title = () => (
  <h1 className="text-9xl font-extrabold leading-none sm:text-title font-stranger lg:mt-32 lg:mb-40">
    {"Let's play"}
...
const Message = () => (
  <p className="max-w-lg mt-8 lg:mb-8 lg:mt-0 text-6xl lg:text-8xl font-stranger">
